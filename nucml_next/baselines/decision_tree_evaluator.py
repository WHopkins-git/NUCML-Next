...
class DecisionTreeEvaluator:
    ...
    def optimize_hyperparameters(
        ...
        # ============================================================================
        # AME enrichment uses left join, creating NaN for isotopes not in database.
        # If we fit the pipeline on data with NaN, the scaler will propagate NaN
        # through standardization (mean/std will be NaN), causing 100% data loss.
        # Solution: Drop NaN rows BEFORE fitting, then warn user about coverage.
